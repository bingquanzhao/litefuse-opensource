  ...
  try {
    ...
    if (params.structuredOutputSchema) {
      ...
      const structuredOutputInstruction =
        openAICompatibleProviderConfig?.structuredOutputInstruction ??
        anthropicCompatibleProviderConfig?.structuredOutputInstruction;
      const structuredOutputMessages = structuredOutputInstruction
        ? [new SystemMessage(structuredOutputInstruction), ...finalMessages]
        : finalMessages;
      ...
      const structuredOutput = await chatModel
        ...
        .invoke(structuredOutputMessages, runConfig);

...
<div align="center">
   ...
   <div>
      <a href="https://litefuse.ai/docs"><strong>ドキュメント</strong></a> ·
      <a href="https://litefuse.ai/issues"><strong>バグ報告</strong></a> ·
      <a href="https://litefuse.ai/ideas"><strong>機能リクエスト</strong></a> ·
      <a href="https://litefuse.ai/changelog"><strong>変更履歴</strong></a> ·
...
- **[プロンプト管理](https://litefuse.ai/docs/prompt-management/get-started):**  
...
- **[LLMプレイグラウンド](https://litefuse.ai/docs/playground):**  
...
[セルフホスティングのドキュメント](https://litefuse.ai/self-hosting)を参照し、アーキテクチャや設定オプションの詳細をご確認ください。
...
| --------------------------------------------------------------------------- | -------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [SDK](https://litefuse.ai/docs/sdk)                                         | Python, JS/TS              | SDKを利用して手動でインストゥルメンテーションを実装し、完全な柔軟性を提供します。                                                                         |
| [OpenAI](https://litefuse.ai/integrations/model-providers/openai-py)        | Python, JS/TS              | OpenAI SDKのドロップイン置換による自動インストゥルメンテーションを実現します。                                                                            |
| [Langchain](https://litefuse.ai/docs/integrations/langchain)                | Python, JS/TS              | Langchainアプリケーションにコールバックハンドラーを渡すことで自動的に計測します。                                                                         |
| [LlamaIndex](https://litefuse.ai/docs/integrations/llama-index/get-started) | Python                     | LlamaIndexのコールバックシステムを介して自動的にインストゥルメントします。                                                                                |
| [Haystack](https://litefuse.ai/docs/integrations/haystack)                  | Python                     | Haystackのコンテンツトレースシステムを利用した自動インストゥルメンテーションを実現します。                                                                |
| [LiteLLM](https://litefuse.ai/docs/integrations/litellm)                    | Python, JS/TS (proxy only) | GPTのドロップイン置換として任意のLLMを使用できます。Azure、OpenAI、Cohere、Anthropic、Ollama、VLLM、Sagemaker、HuggingFace、Replicate（100+ LLM）に対応。 |
...
| 名前                                                                                 | タイプ                     | 説明                                                                                |
| ------------------------------------------------------------------------------------ | -------------------------- | ----------------------------------------------------------------------------------- |
| [Instructor](https://litefuse.ai/docs/integrations/instructor)                       | ライブラリ                 | 構造化されたLLM出力（JSON、Pydantic）を取得するためのライブラリ                     |
| [DSPy](https://litefuse.ai/docs/integrations/dspy)                                   | ライブラリ                 | LLMプロンプトや重み付けを体系的に最適化するためのフレームワーク                     |
| [Mirascope](https://litefuse.ai/docs/integrations/mirascope)                         | ライブラリ                 | LLMアプリケーション構築用のPythonツールキット                                       |
| [Ollama](https://litefuse.ai/docs/integrations/ollama)                               | モデル（ローカル）         | オープンソースLLMを手軽にローカルで実行するためのツール                             |
| [Amazon Bedrock](https://litefuse.ai/docs/integrations/amazon-bedrock)               | モデル                     | AWS上でファウンデーションモデルやファインチューニング済みモデルを実行               |
| [Google VertexAI and Gemini](https://litefuse.ai/docs/integrations/google-vertex-ai) | モデル                     | Google上でファウンデーションモデルやファインチューニング済みモデルを実行            |
| [AutoGen](https://litefuse.ai/docs/integrations/autogen)                             | エージェントフレームワーク | 分散型エージェント構築のためのオープンソースLLMプラットフォーム                     |
| [Flowise](https://litefuse.ai/docs/integrations/flowise)                             | チャット/エージェント UI   | JS/TSのノーコードビルダーで、カスタマイズ可能なLLMフローを構築                      |
| [Langflow](https://litefuse.ai/docs/integrations/langflow)                           | チャット/エージェント UI   | PythonベースのUIで、react-flowを用いてLangChainの実験やプロトタイピングを容易に実現 |
| [Dify](https://litefuse.ai/docs/integrations/dify)                                   | チャット/エージェント UI   | ノーコードでLLMアプリ開発が可能なオープンソースプラットフォーム                     |
| [OpenWebUI](https://litefuse.ai/docs/integrations/openwebui)                         | チャット/エージェント UI   | 自前ホストおよびローカルモデルに対応するLLMチャットWeb UI                           |
| [Promptfoo](https://litefuse.ai/docs/integrations/promptfoo)                         | ツール                     | オープンソースのLLMテストプラットフォーム                                           |
| [LobeChat](https://litefuse.ai/docs/integrations/lobechat)                           | チャット/エージェント UI   | オープンソースのチャットボットプラットフォーム                                      |
| [Vapi](https://litefuse.ai/docs/integrations/vapi)                                   | プラットフォーム           | オープンソースの音声AIプラットフォーム                                              |
| [Inferable](https://litefuse.ai/docs/integrations/other/inferable)                   | エージェント               | 分散型エージェント構築のためのオープンソースLLMプラットフォーム                     |
| [Gradio](https://litefuse.ai/docs/integrations/other/gradio)                         | チャット/エージェント UI   | チャットUIなどのWebインターフェース構築のためのオープンソースPythonライブラリ       |
| [Goose](https://litefuse.ai/docs/integrations/goose)                                 | エージェント               | 分散型エージェント構築のためのオープンソースLLMプラットフォーム                     |
| [smolagents](https://litefuse.ai/docs/integrations/smolagents)                       | エージェント               | オープンソースのAIエージェントフレームワーク                                        |
| [CrewAI](https://litefuse.ai/docs/integrations/crewai)                               | エージェント               | エージェントの協調とツール利用を実現するマルチエージェントフレームワーク            |
...
- GitHub Issuesにて[バグ報告](https://github.com/litefuse/litefuse/issues)を行ってください。
...
- [Issues](https://github.com/litefuse/litefuse/issues)を作成・コメントしてください。
...
Litefuseを利用している主要なオープンソースPythonプロジェクト（スター数順）: ([出典](https://github.com/litefuse/litefuse-docs/blob/main/components-mdx/dependents))
...
詳細につきましては、[セキュリティとプライバシー](https://litefuse.ai/security)ページをご参照ください。

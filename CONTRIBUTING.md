![Litefuse GitHub Banner](https://github.com/selectdb/litefuse-doris/assets/121163007/6035f0f3-d691-4963-b5d0-10cf506e9d42)

# Contributing to Litefuse

First off, thanks for taking the time to contribute! ❤️

The best ways to contribute to Litefuse:

- Submit and vote on [Ideas](https://github.com/orgs/litefuse/discussions/categories/ideas)
- Create and comment on [Issues](https://github.com/selectdb/litefuse-doris/issues)
- Open a PR.
...
We gratefully welcome improvements to documentation ([docs repo](https://github.com/selectdb/litefuse-doris-docs)), the core application (this repo) and the SDKs ([Python](https://github.com/selectdb/litefuse-doris-python), [JS](https://github.com/selectdb/litefuse-doris-js)).
...
_Before making any significant changes, please [open an issue](https://github.com/selectdb/litefuse-doris/issues)._ Discussing your proposed changes ahead of time will make the contribution process smooth for everyone. Changes that were not discussed in an issue may be rejected.

Once we've discussed your changes and you've got your code ready, make sure that tests are passing and open your pull request.

A good first step is to search for open [issues](https://github.com/selectdb/litefuse-doris/issues). Issues are labeled, and some good issues to start with are labeled: [good first issue](https://github.com/selectdb/litefuse-doris/issues?q=is%3Aissue+is%3Aopen+label%3A%22good+first+issue%22).

## Project Overview

We recommend checking out DeepWiki to familiarize yourself with the project:

[![Ask DeepWiki](https://deepwiki.com/badge.svg)](https://deepwiki.com/litefuse/litefuse)
...
- JS SDK ([litefuse/litefuse-js](https://github.com/selectdb/litefuse-doris-js))
  - openapi-typescript to generated types based on OpenAPI spec
- Python SDK ([litefuse/litefuse-python](https://github.com/selectdb/litefuse-doris-python))
...
flowchart TB
    User["UI, API, SDKs"]
    subgraph vpc["VPC"]
        Web["Web Server<br/>(litefuse/litefuse)"]
...
- `web`: is the main application package providing Frontend and Backend APIs for Litefuse.
...
All tests run against a running litefuse instance and **write/delete real data from the database**.
...
You can use the staging environment end-to-end with the Litefuse integrations or SDKs (host: `https://staging.litefuse.ai`). However, please note that the staging environment is not intended for production use and may be reset at any time.

## Production environment

We run two separate release/deployment processes:

1. **Litefuse Cloud deployment (frequent):**
   - Every commit on the `production` branch triggers an ECS deployment to Litefuse Cloud.
   - To deploy current `main` to Litefuse Cloud, promote `main` to `production` via [`promote-main-to-production.yml`](.github/workflows/promote-main-to-production.yml) (instead of force pushing from a local machine).
...
You can trigger the Litefuse Cloud promotion in either way:
...
At Litefuse, we utilize CSS variables to manage our theme settings across the platform.
...
| --light-blue             | Light blue for background of Staging label                         | LitefuseLogo                     |
| --dark-blue              | Dark blue for text and border of Staging label                     | LitefuseLogo                     |

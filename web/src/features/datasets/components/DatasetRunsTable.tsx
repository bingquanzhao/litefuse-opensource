        ...
        <DialogContent className="sm:max-w-xl">
          <DialogHeader>
            ...
            <DialogDescription className="text-md p-0">
              {t(
                "This action cannot be undone and removes all the data associated with {{count}} dataset run.",
                { count: selectedRunIds.length },
              )}
            </DialogDescription>
          </DialogHeader>

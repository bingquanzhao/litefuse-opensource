            ...
            <div className="flex min-w-0 items-center gap-2">
              {isItemVersion && (
                <span
                  ...
                  title={t("Item modified in this version")}
                />
              )}
        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            ...
            >
              ...
              <span className="sr-only">{t("Version actions")}</span>
            </Button>
          </DropdownMenuTrigger>
  ...
  return (
    <div className="flex h-full w-full flex-col">
      ...
      <div className="border-b p-4">
        <h3 className="text-lg font-semibold">{t("Version History")}</h3>
        <p className="text-muted-foreground text-sm">
          {t("{{count}} version", { count: versions.length })}
        </p>
      </div>

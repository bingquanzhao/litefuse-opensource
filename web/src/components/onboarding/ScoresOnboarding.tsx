...
export function ScoresOnboarding() {
  ...
  return (
    <SplashScreen
      title={t("Get Started with Scores")}
      description={t(
      ...
      secondaryAction={{
        label: t("Learn More"),
        href: "https://litefuse.ai/docs/evaluation/evaluation-methods/custom-scores",
      }}
      videoSrc="https://static.litefuse.ai/prod-assets/onboarding/scores-overview-v1.mp4"
    />
  );
}
